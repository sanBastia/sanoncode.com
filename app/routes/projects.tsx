...
export default function ProjectsRoute() {
  ...
  return (
    <Layout>
      <Hero />
      <h1 className="px-4 py-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-4 text-left text-2xl lg:text-3xl">
        Projects
      </h1>
      <p className="sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 text-left text-gray-600">
        Things that i've build and maintain some of them until now
      </p>
